...
--
-- Struktur dari tabel `hak_dan_kewajiban_bawaslu`
--

CREATE TABLE `hak_dan_kewajiban_bawaslu` (
  `id_hak_dan_kewajiban_bawaslu` int(5) NOT NULL,
  `judul` varchar(255) NOT NULL,
  `deskripsi` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `hak_dan_kewajiban_bawaslu`
--

INSERT INTO `hak_dan_kewajiban_bawaslu` (`id_hak_dan_kewajiban_bawaslu`, `judul`, `deskripsi`) VALUES
