...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-mini"><b>PPID</b></span>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url().'dashboard/profil' ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo base_url().'dashboard/user'?>">
            <i class="fa fa-users"></i> <span>USER & HAK AKSES</span>
        </li>
        <li>
          <a href="<?php echo base_url().'dashboard/peraturan'?>">
            <i class="fa fa-edit"></i> <span>PERATURAN</span>
        </li>
        <li>
