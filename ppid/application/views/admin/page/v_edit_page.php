      ...
      <div class="col-md-12">
        <div class="card card-outline card-primary">
          ...
          <div class="card-body pad">
            ...
            <?php foreach($page_edit as $edit): ?>
                <form action="<?php echo base_url('admin/dashboard/simpan_edit/'); ?><?php echo $edit->id ?>" method="post">
                    <div class="form-group">
                        <label>Judul</label>
                        <input type="text" value="<?php echo $edit->judul ?>" name="judul" class="form-control" placeholder="Judul" required>
                    </div>
                    <div class="form-group">
                        <label>Deskripsi</label>
                        <textarea id="summernote" name="deskripsi"><?php echo $edit->deskripsi ?></textarea>
                    </div>
