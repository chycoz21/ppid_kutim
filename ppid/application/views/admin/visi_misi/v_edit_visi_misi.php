      ...
      <div class="col-md-6">
        <div class="card card-outline card-primary">
          ...
          <div class="card-body pad">
            <div class="mb-3">
              <form method="post" action="<?= base_url('admin/dashboard/actionvisimisi');?>" enctype="multipart/form-data">
                <div class="form-group">
                  <label>Judul</label>
                  <input type="hidden" name="id_visi_misi" id="id_visi_misi" value="<?= $id_visi_misi;?>">
                  <input type="text" name="judul" id="judul" class="form-control" value="<?= $judul;?>">
                </div>  
                <div class="form-group">
                  <img src="<?= base_url('assets/admin/upload/visi_misi/'.$foto);?>" alt="Foto" width="150" height="150">
                </div>  
                <div class="form-group">
                  <label>Foto</label>
