      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            ...
            <button class="float-right btn-sm btn-primary"><a class="text-white" href="<?= base_url('admin/dashboard/tambah_kategori');?>">Tambah Data</a></button>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <?php
            ...
            <table id="table-kategori" class="table table-bordered">
              ...
              <tbody>
                <?php $no=1; foreach ($listdatakategori as $data) { ?>
                <tr>
                  <td class="text-center"><?= $no;?></td>
                  <td><?= $data['nama_kategori'];?></td>
                  <td><?= $data['icon'];?></td>
                  <td>
                    <a class="btn-sm btn btn-primary" href="<?= base_url('admin/dashboard/edit_kategori/'.$data['id_kategori']);?>"><i class="fa fa-pencil-alt"></i></a>
                    <a class="btn-sm btn btn-danger" href="<?= base_url('admin/dashboard/actionkategori');?>" data-toggle="modal" data-target="#hapus-data<?= $data['id_kategori'];?>"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
                <!-- Modal -->
                <div class="modal fade" id="hapus-data<?= $data['id_kategori'];?>" tabindex="-1" aria-labelledby="hapus-data" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <form method="post" action="<?= base_url('admin/dashboard/actionkategori');?>">
