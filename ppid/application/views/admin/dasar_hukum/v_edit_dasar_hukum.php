                    ...
                    <div class="card-body pad">
                        <div class="mb-3">
                            ...
                            <?php foreach ($data as $prf) : ?>
                                <form method="post" action="<?= base_url('admin/dashboard/simpan_edit_dasar_hukum/' . $prf->id); ?>" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <?php if ($prf == '') { ?>
                                                Tidak Ada Gambar
                                            <?php } else { ?>
                                                <img src="<?= base_url('assets/admin/upload/dasar_hukum/' . $prf->gambar); ?>" alt="Foto">
                                            <?php } ?>
                                        </div>
                                        <div class="form-group">
