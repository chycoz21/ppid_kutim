    <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay text-center">
            <h1 class="card-title ">TUGAS FUNGSI DAN WEWENANG</h1>
        </div>
    </div>
    <!-- akhir jumbotron -->
            ...
            <div class="row">
                <div class="col-lg-8 mb-5">
                    <?php foreach($gambar as $gbr): ?> 
                        <img src="<?php echo base_url("assets/admin/upload/tugas_fungsi/").$gbr->gambar ?>" alt="Foto Tugas Fungsi Dan Wewenang" style="width:100%;">
                    <?php endforeach;?>
                </div>
                <!-- akhir table -->
