...
<div class="card bg-dark text-white">
    ...
    <div class="card-img-overlay text-center">
        <h1 class="card-title ">INFORMASI BERKALA</h1>
    </div>
</div>
<!-- akhir jumbotron -->
            ...
            <div class="col-lg-8 mb-4">
                <div class="card">
                    <div class="card-header bg-white">
                        <h4 class="card-title">LIST INFORMASI BERKALA</h4>
                    </div>
                    <div class="card-body">
                        <table id="table-berkala" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php $no=1; foreach ($listberkala as $data) { ?>
                                <tr>    
