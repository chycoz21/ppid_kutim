...
<div class="card bg-dark text-white">
    <img class="card-img" src="<?= base_url();?>assets/home/img/profil1.jpg" alt="Card image" style="min-height:40vh;">
    <div class="card-img-overlay text-center">
        <?php foreach ($listprosedurpermohonansengketa as $data) { ?>
            <h1 class="card-title-kecuali"><?= $data['judul'];?></h1>
        <?php } ?>
    </div>
</div>
<!-- akhir jumbotron -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mb-5">
                <?php foreach ($listprosedurpermohonansengketa as $data) { ?>
                    <img src="<?= base_url('assets/admin/upload/prosedur_permohonan/'.$data['foto']);?>" alt="Prosedur Permohonan Penyelesaian Sengketa Informasi" style="width: 100%;">
                <?php } ?>
            </div>
            <!-- akhir table -->
