...
<div class="card bg-dark text-white">
    <img class="card-img" src="<?= base_url();?>assets/home/img/profil1.jpg" alt="Card image" style="min-height:30vh;">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mb-5">
                <?php foreach ($listprosedurpengajuankeberatan as $data) { ?>
                    <img src="<?= base_url('assets/admin/upload/prosedur_pengajuan/'.$data['foto']);?>" alt="Prosedur Pengajuan Keberatan" style="width: 100%;">
                <?php } ?>
            </div>
            <!-- akhir table -->
