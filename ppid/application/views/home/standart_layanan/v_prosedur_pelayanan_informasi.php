...
<div class="card bg-dark text-white">
    <img class="card-img" src="<?= base_url();?>assets/home/img/profil1.jpg" alt="Card image" style="min-height:25vh;">
    <div class="card-img-overlay text-center">
        <?php foreach ($listprosedurpelayananinformasi as $data) { ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mb-5">
                <?php foreach ($listprosedurpelayananinformasi as $data) { ?>
                    <img src="<?= base_url('assets/admin/upload/prosedur_pelayanan/'.$data['foto']);?>" alt="Prosedur Pelayanan Informasi" style="width: 100%;">
                <?php } ?>
            </div>
            <!-- akhir table -->
